...
The different libraries in the nxpUSBlib package are designed to run on many 
...
Configure projects:
  ...
  repeat these steps with the CDL, nxpUSBlib, and Project_EA_AndroidAccessory
...
Configure the indexer:
   click Window->Preferences->C/C++->Indexer->Use active build configuration
                                  ...
                                  BSP             CDL     nxpUSBlib    Project_EA_AndroidAccessory    MCU
                        ======================  =======  ============  ===========================  =======
